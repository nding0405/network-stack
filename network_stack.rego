...
valid(ethernetDevice) {
	...
	data.compartment.compartment_call_allow_list("TCPIP", "network_socket_udp_authorise_host_internal.*", {"NetAPI"})
	...
	data.compartment.compartment_call_allow_list("Firewall", "firewall_add_udpipv4_endpoint.*", {"TCPIP"})
	...
	data.compartment.compartment_call_allow_list("Firewall", "firewall_add_udpipv6_endpoint.*", {"TCPIP"})
